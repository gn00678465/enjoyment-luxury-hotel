import { definePreset, transformerVariantGroup, transformerCompileClass } from 'unocss';
...
export interface PresetSharedOptions extends PresetDarkModeThemeOptions {
